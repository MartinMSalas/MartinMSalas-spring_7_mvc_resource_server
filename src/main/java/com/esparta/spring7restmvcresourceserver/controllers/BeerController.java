...
import com.esparta.spring7restmvcresourceserver.exceptions.BadRequestException;
import com.esparta.spring7restmvcresourceserver.model.BeerDTO;

import com.esparta.spring7restmvcresourceserver.services.BeerService;
...
public class BeerController {
    ...
    */
    ...
    public ResponseEntity<BeerDTO> createNewBeer(@Validated @RequestBody BeerDTO beerDTO){
        ...
        //headers.add("Location","/api/v1/beer/" + "test");
